...
const DropMenu: FC<DropMenuProps> = ({ options, defaultValue }) => {
  const [currentValue, setCurrentValue] =
    useState<IWatchCategory>(defaultValue);
  ...
  return (
    <div className={classes["dropmenu"]}>
      <div
        className={[
          classes["dropmenu__btn"],
          classes[`dropmenu__btn_${currentValue.accessor}`],
        ].join(" ")}
      ...
      >
        ...
        <MdOutlineKeyboardArrowDown
          className={
            isVisible
              ? [classes["arrow"], classes["rotate"]].join(" ")
              : classes["arrow"]
          }
        />
      </div>
      ...
      <div
        className={
          isVisible
            ? [classes["dropmenu__options"], classes["active"]].join(" ")
            : classes["dropmenu__options"]
        }
      >
        {options.map(
          (option, index) =>
