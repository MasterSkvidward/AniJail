...
const DropMenu: FC<DropMenuProps> = ({options, defaultValue}) => {
    ...
    return (
        <div className={classes['dropmenu']}>
            ...
            <div className={[classes['dropmenu__btn'], classes[`dropmenu__btn_${currentValue.accessor}`]].join(' ')} onClick={handlerButtonClick}>
            ...
            <div className={isVisible?  [classes['dropmenu__options'], classes['active']].join(' ') : classes['dropmenu__options']}>
                {options.map((option, index) =>
                    option.accessor !== currentValue.accessor &&  
                        <div 
                            className={classes[`dropmenu__option`]}
                ...
                {currentValue.accessor !== defaultValue.accessor &&
                    <div 
                        className={classes[`dropmenu__option`]} 
                        onClick={() => setCurrentValue(defaultValue)}>{'Delete from list'}</div>
                }
