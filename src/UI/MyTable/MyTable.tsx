                    ...
                    <tr key={index} onClick={() => navigate((`/anime/${item?.mal_id}`))}>
                        ...
                        <td>
                            <div className={classes['anime']}>
                                <div style={{background: `url(${item.images.jpg.image_url}) 0 0 / cover no-repeat`}} className={classes['anime__image']}>
                                ...
                                <div className={classes['anime__body']}>
                                    ...
                                    <div className={classes['anime__year']}>{item.year ? item.year : '-'}</div>
                        ...
                        <td>
                           <div className={classes['anime__type']}>{item.type? item.type : '-'}</div>
                        </td>
