...
const MyRating:FC<MyRatingProps> = ({setUserRating, setRatingVisible, maxWidth, width, items=10}) => {
    ...
    return (
        <div  style={{ maxWidth: maxWidth, width: '200%', display: 'flex', flexDirection: 'column', rowGap: 15}} onClick={handlerClick}>
            <Rating
            value={rating}
        ...
        <div
            ...
            <span
                ...
                style={{
                opacity: (index*2 + 1 === rating || index*2 + 2 === rating) ? 1 : 0.35,
