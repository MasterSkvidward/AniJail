...
import classes from '../../styles/ProfileStatistics.module.scss';
...
const ProfileStatistics: FC<ProfileStatisticsProps> = ({currentUser}) => {
    ...
    const friends = [currentUser, currentUser, currentUser, currentUser, currentUser, currentUser, currentUser, currentUser, currentUser, currentUser, currentUser, currentUser, currentUser, currentUser, currentUser];
       ...
       <section className={classes['statistics']}>
           ...
           <div className={[classes['statistics__container'], '_container1800'].join(' ')}>
                <div className={classes['statistics__time']}>
                    <div className={classes['statistics__title']}><h5>Время за аниме</h5><h5>{'3 months 2 days'}</h5></div>
                    <div className={classes['statistics__block']}>
                        ...
                        <div className={classes['statistics__labels']}>
                            <div className={classes['statistics__label']}><span>2 weeks</span></div>
                            <div className={classes['statistics__label']}><span>1 month</span></div>
                            <div className={classes['statistics__label']}><span>3 months</span></div>
                            <div className={classes['statistics__label']}><span>6 months</span></div>
                            {/* <span>1 month</span>
                            <span>3 months</span>
                            <span>6 months</span> */}
                        </div>
