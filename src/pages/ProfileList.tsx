...
import AnimeWatchList from '../components/Anime/AnimeWatchList';
import classes from '../styles/ProfileList.module.scss';
       ...
       <div className={classes['list']}>
            <div className={'_container1800'}>
                <div className={classes['go-back']}>
                    ...
                    <h4 className={classes['go-back__name']} onClick={handlerClickBack}>{user.username}</h4>
                </div>
                <AnimeSearch/>
                <AnimeWatchList/>
            </div>
